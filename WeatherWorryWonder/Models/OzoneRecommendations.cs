...
namespace WeatherWorryWonder.Models
{
    public class OzoneRecommendations      //Callista
    {
        ...
        public String[] OzoneLevels = new String[6] { "Air quality is considered satisfactory, and air pollution poses little or no risk.",
        ...
        public String[] OzoneDriving = new String[7] {"Carpool and combine errands to reduce trips.",
        ...
        public String[] OzoneHome = new String[8] {"Reduce the amount of energy you use at home.Much of our energy comes from fossil fuel-burning power plants that produce ozone.",
        ...
        public String[] OzoneWork = new String[6] {"Allow and promote teleconferencing instead of driving to meetings. If you must drive, carpool when possible.",
        ...
        public String[] OzoneGrilling = new String[5] {"Do not use lighter fluid. It pollutes on both evaporation and burning. Your food will taste better without it, too!",
        ...
        public String[] OzoneYardWork = new String[6] {"Mow as late as possible, preferably after 7 pm, when there is less sun and heat.",
